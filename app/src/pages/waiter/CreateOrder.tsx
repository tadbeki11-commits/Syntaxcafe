...
// Custom Hooks
import { useWaiterCreateOrder } from './hooks/useWaiterCreateOrder';

// Shared Cashier Modular Components
import OrderFiltersPanel from '@/pages/cashier/components/CreateOrder/OrderFiltersPanel';

// Waiter Modular Components
import WaiterHeader from './components/CreateOrder/WaiterHeader';
...
import MenuItemCard from '../cashier/components/CreateOrder/MenuItemCard';
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#fafaf9] font-sans selection:bg-amber-100 selection:text-amber-900 flex flex-col animate-in fade-in duration-300">
      ...
      <WaiterHeader
        ...
        onNavigateToHistory={() => navigate('/waiter/order-history')}
        onNavigateToDashboard={() => navigate('/waiter/dashboard')}
