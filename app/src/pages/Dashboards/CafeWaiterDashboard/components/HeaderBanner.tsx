    ...
    <Card className="border border-primary/20 bg-gradient-to-r from-primary/10 via-background to-background shadow-sm">
      <CardContent className="pt-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-lg font-extrabold text-foreground">Café Table Service</h1>
              <BranchBadge />
            </div>
            <p className="text-xs text-muted-foreground font-semibold">
              Welcome, {userName} • Manage orders and shifts efficiently
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          {attendanceStatus ? (
            <div className="flex items-center gap-3">
              <Badge variant="success" className="h-9 px-3 text-xs font-bold gap-1">
